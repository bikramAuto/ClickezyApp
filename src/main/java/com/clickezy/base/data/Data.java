package com.clickezy.base.data;

public class Data {
	
	//SignUp
	protected String NewID = "demo155";
	...
	protected String mob = "9937123523";
	
	//Studio Data
	protected String StudioName = "Demo Studio23";
	...
	//User SighIn
	protected String Lmail = "demo155@mailsac.com";
	protected String Lmob = "9937123523";
	...
	//Booking time
	protected String h = "11";
	protected String m = "35";
